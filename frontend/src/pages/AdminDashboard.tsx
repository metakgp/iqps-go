...
function AdminDashboard() {
  ...
  const [selectedQPaperIndex, setSelectedQPaperIndex] = useState<number | null>(
    null
  );
    ...
    <div id="admin-dashboard">
      ...
      {selectedQPaperIndex !== null && (
        <PaperEditModal
          ...
          onDelete={
            unapprovedPapers[selectedQPaperIndex].from_library
              ? undefined
              : (e) => {
                  e.preventDefault();
                  handlePaperDelete(unapprovedPapers[selectedQPaperIndex]);
                }
          }
          selectNext={
